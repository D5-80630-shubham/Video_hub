    ...
    return (
       <Stack direction={['column','row']}>
        <VStack w={'full'}>
            ...
            <VStack alignItems={'flex-start'} p={'full'} w={'full'} overflowY={'auto'}>
                <Heading>Sample Video 1</Heading>
                <Text>
                    Lorem ipsum, dolor sit amet consectetur
                    adipisicing elit. Vero voluptate rem 
                    incidunt provident quam aspernatur velit
                    optio doloremque odit! Sequi.
                </Text>
            </VStack>
        </VStack>
        <VStack w={['full','xl']} alignItems={'stretch'} p={'8'} spacing={'8'} overflowY={'auto'}>
            ...
            videosArr.map((item, index) =>(
                <Button variant={'ghost'} colorScheme="purple" onClick={()=> setVideoSrc(item)}>Video {index+1}
                </Button>
                ))
            }
        </VStack>
